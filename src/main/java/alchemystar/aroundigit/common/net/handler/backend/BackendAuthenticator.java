...
import alchemystar.aroundigit.common.net.exception.UnknownCharsetException;
import alchemystar.aroundigit.common.net.exception.UnknownPacketException;
import alchemystar.aroundigit.common.net.handler.backend.resulthandler.GitModeResultHandler;
import alchemystar.aroundigit.common.net.handler.backend.resulthandler.PositionResultHandler;
import alchemystar.aroundigit.common.net.proto.MySQLPacket;
import alchemystar.aroundigit.common.net.proto.mysql.AuthPacket;
...
import alchemystar.aroundigit.common.net.proto.mysql.HandshakePacket;
import alchemystar.aroundigit.common.net.proto.mysql.OkPacket;
import alchemystar.aroundigit.common.net.proto.util.Capabilities;
import alchemystar.aroundigit.common.net.proto.util.CharsetUtil;
import alchemystar.aroundigit.common.net.proto.util.SecurityUtil;
...
public class BackendAuthenticator extends ChannelHandlerAdapter {
    ...
    private void position() {
        // todo local position
        if(source.getBinlogContext().getBinLogFileName() == null) {
            autoPosition();
        }else{
    ...
    private void autoPosition() {
        source.setResultSetHander(new PositionResultHandler(source));
        source.write(new CommandPacket("show master status", MySQLPacket.COM_QUERY));
    }
